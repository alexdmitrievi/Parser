    ...
    return _process_and_save(
        scraper.run(
            queries=[
                ...
                "ремонт помещений", "капитальный ремонт", "строительные работы",
                "строительно-монтажные работы", "благоустройство территории",
                "реконструкция", "текущий ремонт", "ремонт дорог",
                # Поставки
                "поставка оборудования", "поставка мебели", "поставка продуктов",
                "поставка медикаментов", "поставка канцтоваров",
                "поставка компьютерного оборудования", "поставка спецодежды",
                # Услуги
                "оказание услуг", "IT услуги", "транспортные услуги",
                "охранные услуги", "клининг", "уборка территории",
                "техническое обслуживание", "обслуживание зданий",
                "аудиторские услуги", "юридические услуги",
                # Медицина
                "медицинское оборудование", "лекарственные средства",
                # Проекты
                "проектные работы", "проектно-изыскательские работы",
                # Прочее
                "электромонтажные работы", "вывоз мусора",
                "озеленение", "спил деревьев", "дератизация",
            ],
            max_pages=3,
        ),
        "EIS API",
