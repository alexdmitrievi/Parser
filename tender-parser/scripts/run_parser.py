...
def run_eis_api() -> int:
    ...
    return _process_and_save(
        scraper.run(
            queries=[
                "поставка оборудования", "ремонт помещений", "строительно-монтажные работы",
                "оказание услуг", "поставка продуктов", "медицинское оборудование",
                "IT услуги", "канцтовары", "мебель поставка", "транспортные услуги",
                "уборка территории", "охранные услуги", "благоустройство",
                "ремонт Москва", "поставка Москва", "строительство Москва",
                "ремонт Санкт-Петербург", "ремонт Краснодар", "ремонт Новосибирск",
                "поставка Омск", "мебель Екатеринбург", "ремонт Казань",
                "закупка продуктов питания", "техническое обслуживание",
                "проектные работы", "клининг", "текущий ремонт",
            ],
            max_pages=2,
        ),
        "EIS API",
