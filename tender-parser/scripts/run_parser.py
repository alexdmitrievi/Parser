    ...
    return _process_and_save(
        scraper.run(
            queries=[
                ...
                "ремонт помещений", "строительные работы", "капитальный ремонт",
                "благоустройство", "реконструкция", "электромонтажные работы",
                # Поставки
                "поставка оборудования", "поставка мебели", "поставка продуктов",
                "поставка медикаментов", "поставка спецодежды",
                # ГСМ и топливо
                "мазут", "печное топливо", "дизельное топливо", "бензин",
                "ГСМ", "нефтепродукты", "уголь",
                # Услуги
                "IT услуги", "транспортные услуги", "охранные услуги",
                "клининг", "техническое обслуживание", "проектные работы",
                # Медицина
                "медицинское оборудование", "лекарственные средства",
                # Прочее
                "канцтовары", "спецтехника", "автозапчасти",
                "вывоз мусора", "озеленение", "спил деревьев",
                "утилизация", "страхование", "аудит",
            ],
            max_pages=2,
        ),
        "EIS API",
